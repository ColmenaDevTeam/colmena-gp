		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<p class="text-left"><a href="{{url("/roles/registrar")}}" class="btn btn-info">Registrar</a></p>
						...
						<thead>
							...
							<tbody>
								@foreach($roles as $role)
									<tr>
										<td><a href="{{url("/roles/ver/$role->id")}}">{{$role->name}}</a></td>
										<td>{{$role->level}}</td>
										<td>
											<a class="btn" id="update" href="{{url("/roles/modificar/$role->id")}}">
